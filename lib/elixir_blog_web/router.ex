defmodule ElixirBlogWeb.Router do
  ...
  pipeline :browser do
    ...
    plug :put_root_layout, {ElixirBlogWeb.LayoutView, :root}
  ...
  scope "/", ElixirBlogWeb do
    ...
    resources "/posts", PostController, only: [:show, :new, :create, :delete] do
      post "/likes/:type", LikeController, :create
      patch "/likes", LikeController, :update
      delete "/likes", LikeController, :delete

      resources "/comments", CommentController, only: [:new, :create, :delete] do
        post "/likes/:type", LikeController, :create
        patch "/likes", LikeController, :update
        delete "/likes", LikeController, :delete
      end
